...
const Navbar = () => {
  ...
  navbar = `
  <button type="button" class="btn btn-secondary" data-uri="/">Dactylographier</button>
  <button type="button" class="btn btn-secondary" data-uri="/creerTexte">Créer un texte</button>`;
